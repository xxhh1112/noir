...
impl<'block> BrilligBlock<'block> {
    ...
    pub(crate) fn compile(
        ...
        brillig_block.convert_block(dfg, brillig);
    }

    fn convert_block(&mut self, dfg: &DataFlowGraph, brillig: &Brillig) {
        ...
        match instruction {
            ...
            Instruction::Call { func, arguments } => match &dfg[*func] {
                ...
                Value::Function(func_id) => {
                    ...
                    let function_block_label: String = self.create_block_label(self.block_id);
