...
export class BridgeId {
  ...
  constructor(
    ...
    this.bitConfig = new BitConfig(
      inputAssetIdB !== undefined,
      outputAssetIdB !== undefined
    );
  }
  ...
  static fromBigInt(val: bigint) {
    ...
    const inputAssetIdA = getNumber(
      val,
      INPUT_ASSET_ID_A_OFFSET,
      INPUT_ASSET_ID_A_LEN
    );
    const outputAssetIdA = getNumber(
      val,
      OUTPUT_ASSET_ID_A_OFFSET,
      OUTPUT_ASSET_ID_A_LEN
    );
    const inputAssetIdB = getNumber(
      val,
      INPUT_ASSET_ID_B_OFFSET,
      INPUT_ASSET_ID_B_LEN
    );
    const outputAssetIdB = getNumber(
      val,
      OUTPUT_ASSET_ID_B_OFFSET,
      OUTPUT_ASSET_ID_B_LEN
    );
    ...
    const bitConfig = BitConfig.fromBigInt(
      BigInt(getNumber(val, BITCONFIG_OFFSET, BITCONFIG_LEN))
    );
