...
describe("serialize", () => {
  it("serialize buffer to vector and deserialize it back", () => {
    ...
    const paddedVector = Buffer.concat([
      randomBytes(10),
      vector,
      randomBytes(20),
    ]);
  ...
  it("serialize buffer array to vector and deserialize it back", () => {
    ...
    const recoveredUintArr = deserializeArrayFromVector(
      deserializeUInt32,
      uintArrVec
    );
    ...
    const paddedUintArrVec = Buffer.concat([
      randomBytes(10),
      uintArrVec,
      randomBytes(20),
    ]);
    const recoveredUintArr2 = deserializeArrayFromVector(
      deserializeUInt32,
      paddedUintArrVec,
      10
    );
    ...
    const recoveredFieldArr = deserializeArrayFromVector(
      deserializeField,
      fieldArrVec
    );
    ...
    const paddedFieldVec = Buffer.concat([
      randomBytes(10),
      fieldArrVec,
      randomBytes(20),
    ]);
    const recoveredFieldArr2 = deserializeArrayFromVector(
      deserializeField,
      paddedFieldVec,
      10
    );
