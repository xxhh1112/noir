...
describe("schnorr", () => {
  ...
  it("should create + verify multi signature", () => {
    ...
    // generate signature
    const signature = schnorr.multiSigCombineSignatures(
      msg,
      pubKeys,
      roundOnePublicOutputs,
      roundTwoOutputs
    ...
    const verified = schnorr.verifySignature(
      msg,
      schnorr.multiSigValidateAndCombinePublicKeys(pubKeys),
      signature
    );
