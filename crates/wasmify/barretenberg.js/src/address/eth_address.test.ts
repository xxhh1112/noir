...
describe("address", () => {
  it("should return correct string", () => {
    const address = EthAddress.fromString(
  ...
  it("should create address from 32 byte buffer", () => {
    ...
    expect(new EthAddress(buffer)).toEqual(
      EthAddress.fromString("0xc6d9d2cD449A754c494264e1809c50e34D64562b")
    );
  });
  ...
  it("should have correct zero address", () => {
    expect(EthAddress.ZERO.toString()).toBe(
  ...
  describe("isAddress", () => {
    it(`should return true for valid prefixed address`, () => {
      expect(
        EthAddress.isAddress("0xc6d9d2cd449a754c494264e1809c50e34d64562b")
      ).toBe(true);
    });

    it(`should return true for valid unprefixed address`, () => {
      expect(
        EthAddress.isAddress("c6d9d2cd449a754c494264e1809c50e34d64562b")
      ).toBe(true);
    });
    ...
    it(`should return true for correctly checksummed address`, () => {
      expect(
        EthAddress.isAddress("0xE247A45c287191d435A8a5D72A7C8dc030451E9F")
      ).toBe(true);
    });
    ...
    it(`should return false for non hex characters`, () => {
      expect(
        EthAddress.isAddress("0xg6d9d2cd449a754c494264e1809c50e34d64562b")
      ).toBe(false);
    });
  });
