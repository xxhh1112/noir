...
export class NoteAlgorithms {
  ...
  public valueNoteNullifierBigInt(
    noteCommitment: Buffer,
    accountPrivateKey: Buffer,
    real = true
  ) {
    return toBigIntBE(
      this.valueNoteNullifier(noteCommitment, accountPrivateKey, real)
    );
  }
  ...
  public valueNotePartialCommitment(
    noteSecret: Buffer,
    ...
    this.wasm.call(
      "notes__value_note_partial_commitment",
      0,
      32,
      96,
      accountRequired,
  ...
  public claimNoteCompletePartialCommitment(
    partialNote: Buffer,
    ...
    this.wasm.call(
      "notes__claim_note_complete_partial_commitment",
      0,
      interactionNonce,
      32,
      0
  ...
  public claimNoteCommitment(note: TreeClaimNote) {
    ...
    return this.claimNoteCompletePartialCommitment(
      partial,
      note.defiInteractionNonce,
      note.fee
    );
  }
