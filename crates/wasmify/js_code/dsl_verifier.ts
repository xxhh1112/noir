...
import { BarretenbergWorker } from "../barretenberg.js/dest/wasm";
...
export class DSLVerifier {
    ...
    public async computeKey(pippenger: SinglePippenger, g2Data: Uint8Array) {
        ...
        const g2Ptr = await this.worker.call('bbmalloc', g2Data.length);
        // await this.worker.transferToHeap(g2Data, 0);
        await this.worker.call('standard_example__init_verification_key', pippenger.getPointer(), g2Ptr);
    }
